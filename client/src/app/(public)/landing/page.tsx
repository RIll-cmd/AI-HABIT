...
import { Sparkles, ArrowRight, ShieldCheck, Zap, Bot, Dumbbell, Award, Flame, Target, ChevronRight } from "lucide-react";
  ...
  return (
    <div className="flex-1 flex flex-col bg-[#0B1020] text-slate-100 relative overflow-hidden">
      ...
      <section className="relative px-6 py-20 md:py-32 max-w-6xl mx-auto flex flex-col items-center text-center z-10">
        <Badge variant="default" className="mb-6 px-3.5 py-1 text-xs border border-blue-500/30 bg-blue-950/50 backdrop-blur-sm text-blue-300">
        ...
        <p className="mt-6 text-base md:text-lg text-slate-300 max-w-2xl font-sans leading-relaxed">
          Level up your physical attributes, master habits, conquer daily quests, and let AI Administrator <span className="text-blue-400 font-semibold">Ciel</span> guide your evolution.
        </p>

        {/* HERO CALL TO ACTION BUTTONS */}
        <div className="mt-10 flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
          <Button variant="default" size="lg" asChild className="w-full sm:w-auto px-8 h-12 text-sm font-bold shadow-lg shadow-blue-600/25 hover:shadow-blue-600/40 transition-all">
            <Link href="/register">
          ...
          <Button variant="outline" size="lg" asChild className="w-full sm:w-auto px-8 h-12 text-sm font-bold border-white/15 bg-white/5 hover:bg-white/10 hover:border-white/25 transition-all">
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-4 w-full max-w-4xl">
          <div className="p-5 rounded-[20px] bg-[#151C33]/80 border border-white/10 backdrop-blur-sm text-center hover:border-blue-500/30 transition-all">
            <div className="text-2xl md:text-3xl font-bold font-mono text-blue-400">7 Core</div>
            <div className="text-xs text-slate-400 font-sans mt-1">Attributes Tracked</div>
          </div>
          ...
          <div className="p-5 rounded-[20px] bg-[#151C33]/80 border border-white/10 backdrop-blur-sm text-center hover:border-emerald-500/30 transition-all">
            <div className="text-2xl md:text-3xl font-bold font-mono text-emerald-400">Real-Time</div>
            <div className="text-xs text-slate-400 font-sans mt-1">XP & Habit Loops</div>
          </div>
          ...
          <div className="p-5 rounded-[20px] bg-[#151C33]/80 border border-white/10 backdrop-blur-sm text-center hover:border-purple-500/30 transition-all">
            <div className="text-2xl md:text-3xl font-bold font-mono text-purple-400">Ciel AI</div>
            <div className="text-xs text-slate-400 font-sans mt-1">System Guidance</div>
          </div>
          ...
          <div className="p-5 rounded-[20px] bg-[#151C33]/80 border border-white/10 backdrop-blur-sm text-center hover:border-amber-500/30 transition-all">
            <div className="text-2xl md:text-3xl font-bold font-mono text-[#F6C453]">Ascension</div>
            <div className="text-xs text-slate-400 font-sans mt-1">Tower & Boss Raids</div>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-20 bg-[#0B1020]/90 border-t border-white/10 relative z-10">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            <Badge variant="outline" className="mb-3 text-[11px] border-white/10 text-slate-400">CORE MODULES</Badge>
            ...
            <p className="text-xs md:text-sm text-slate-400 mt-2 font-sans max-w-xl mx-auto">
              Transform your daily discipline with real RPG feedback metrics and AI analysis.
            </p>
          </div>
            ...
            <Card className="bg-[#151C33]/90 border-white/10 hover:border-blue-500/40 transition-all duration-300 group">
              <CardHeader>
                ...
                <CardDescription className="text-xs text-slate-400">
                  Autonomous feedback loops provided by system administrator Ciel.
                </CardDescription>
              </CardHeader>
              <CardContent>
